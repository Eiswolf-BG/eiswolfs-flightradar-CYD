...
- **Quick header shortcuts** – tap the WiFi signal bars in the header to jump straight to WiFi settings, or tap the app title for a QR code linking to this project's GitHub page
