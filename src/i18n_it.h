...
static const char* const I18N_IT[] = {
    ...
    "Si sta installando l'aggiornamento...",
    "Non scollegare né spegnere il dispositivo durante l'aggiornamento.",
    "Aggiornamento fallito",
    "Aggiornamento installato",
    "Il nuovo firmware è stato installato correttamente.",
    "Se questo progetto ti piace, sarei felice di ricevere una stella su GitHub: github.com/Eiswolf-BG/eiswolfs-flightradar-CYD",
    "Il dispositivo si riavvierà ora automaticamente.",
    ...
    "Tocca per impostare come preset",
    ...
    "Chiudi",
    "Monitoraggio e foto su FlightAware",
    ...
    " · portata ",
    "Corrispondenza lista di controllo",
    "Aggiungi a Home (pulsante Condividi) per la visualizzazione a schermo intero",
    "Aggiungi a Home (menu del browser) per la visualizzazione a schermo intero",
    "Gestisci filtro compagnie e lista di controllo",
    "Diario di volo",
    "Eliminazione...",
    "Preparazione...",
    "Filtra per data...",
    "Scarica CSV unito (tutti i giorni)",
    "Data",
    "Aerei",
    "Scarica",
    "Elimina",
    "Rimuovi",
    "Nessuna compagnia nascosta per ora.",
    "Prefisso ICAO",
    "Diario di volo",
    "es. DLH",
    "es. DLH441",
    ...
    "Radar live",
    "Casa",
    "Suono di allerta web",
    "Info sul suono di allerta web",
    "Per impostazione predefinita, questo suono non proviene dal dispositivo stesso - viene riprodotto nel browser di qualsiasi telefono, Mac o PC che abbia attualmente aperta la pagina web del radar live, quando appare un aereo controllato (lista di controllo per indicativo o per squawk) o un codice squawk di emergenza. Se colleghi anche un altoparlante al connettore SPK del dispositivo, quest'ultimo ora emette lo stesso avviso anche direttamente: un breve segnale acustico singolo per una corrispondenza nella lista di controllo, una sirena continua per un codice squawk di emergenza. Senza altoparlante collegato non noterai nulla, il pin resta semplicemente silenzioso. Consiglio: per una buona qualità audio, è meglio riprodurre il suono tramite la pagina del radar live su telefono, Mac o PC. Se vuoi comunque collegare un altoparlante direttamente, puoi farlo, ma dovrai convivere con il noto rumore di scansione e la qualità audio generalmente debole della scheda CYD. Questo interruttore attiva o disattiva completamente il suono su tutte queste vie.",
    "Riproduce un suono di allerta in questo browser per un codice squawk di emergenza o una corrispondenza nella lista di controllo, finché questa pagina resta aperta. Se un altoparlante è collegato al dispositivo, lo stesso avviso ora suona anche direttamente lì (vedi \"Suono di allerta web\" nel menu del dispositivo). Clicca per disattivare - riguarda solo questo browser, l'altoparlante del dispositivo non ne è influenzato.",
    ...
    "Segnale WiFi: ",
    "Memoria libera: ",
    "Blocco libero più grande: ",
    "Ultima richiesta ADS-B: ",
    "Info sul blocco libero più grande",
    "La memoria libera può sembrare complessivamente a posto anche se è suddivisa in tanti piccoli frammenti sparsi. Questo valore mostra il blocco più grande realmente disponibile in modo contiguo, importante per una nuova connessione di rete (HTTPS/TLS) o una grande allocazione. Se è molto più piccolo della memoria libera totale, l'heap è frammentato - questo è già stato in passato la vera causa di alcuni bug complicati.",

    "Push ntfy.sh",
    "Push ntfy.sh",
    "Attivo",
    "Topic: ",
    "Inserisci il topic ntfy.sh",
    "Invia push di prova",
    "Inviato",
    "Info su ntfy.sh Push",
    "ntfy.sh è un servizio gratuito di notifiche push, senza bisogno di account. Installa l'app gratuita ntfy sul tuo telefono e iscriviti allo stesso nome di topic inserito qui; ogni messaggio inviato a quel topic apparirà come notifica. Sul server pubblico gratuito, il nome del topic NON è segreto - chiunque lo conosca (o lo indovini) potrebbe leggere le tue notifiche. Scegli quindi qualcosa di unico e difficile da indovinare, non una parola semplice.",
    "Codice squawk di emergenza ",
    "Corrispondenza nella lista di controllo: ",
    "Notifica di prova da Eiswolfs Flightradar ✅",

    "Statistiche sessione",
    "Statistiche sessione",
    "Dall'ultimo riavvio - torna a zero a ogni riavvio.",
    "Aerei rilevati: ",
    "Passaggio più ravvicinato: ",
    "Più veloce: ",
    "Più alto: ",
    "Tipo più frequente: ",
    "ancora nessun dato",
